...
date: 7 декабря, 2021, Москва, Россия
...
![Листинг программы](image/01.png){ #fig:004 }

## Реализация алгоритма

![Листинг программы](image/02.png){ #fig:005 }

## Пример работы программы

![Работа алгоритма гаммирования](image/03.png){ #fig:006 }
